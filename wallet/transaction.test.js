...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when a transaction is invalid', () => {
            describe('when a transaction outputMap is invalid', () => {
            ...
            describe('when a transaction input signature is invalid', () => {
                it('returns false and logs an error', () => {
    ...
    describe('update()', () => {
        let originalSignature, originalSenderOutput, nextRecipient, nnextAmount;
        ...
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({
                        senderWallet, recipient: 'foo', amount: senderWallet.balance + 1
                    });
